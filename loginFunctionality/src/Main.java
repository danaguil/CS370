...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        HashMap<String, User> usernameMap = new HashMap<>(); // init the hashmap
        Scanner scanner = new Scanner(System.in); // for taking inputs

        // Sample data
        User user1 = new User("john@example.com", "john123", "password123");
     ...
     */
    public static void userChoice(int choice, HashMap<String, User> usernameMap, Scanner scanner) {
        switch (choice) {
            case 1:
